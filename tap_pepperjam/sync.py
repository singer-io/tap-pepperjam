...
from tap_pepperjam.transform import transform_json
from tap_pepperjam.streams import STREAMS
...
def sync_endpoint(
    ...
    while start_window < now_datetime:
        ...
        offset = 0
        limit = 500 # Default limit for Pepperjam API, unable to change this
        total_records = 0
        ...
        # Pepperjam API does not allow page/batch sorting; bookmark written for date window
        if bookmark_field:
